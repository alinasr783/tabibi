...
export default function IntegrationsPage() {
  ...
  const [integrations, setIntegrations] = useState([
    ...
    },
    {
      id: "vezeeta",
      title: "Vezeeta",
      description: "جاري العمل تقنياً عليه وهيكون جاهز في خلال أيام",
    ...
    },
    {
      ...
      title: "Ekshef",
      description: "جاري العمل تقنياً عليه وهيكون جاهز في خلال أيام",
      iconUrl: "https://www.google.com/s2/favicons?domain=ekshef.com&sz=128",
      scope: "",
      bgColor: "bg-primary/10",
      connected: false,
      isComingSoon: true,
    },
    {
      ...
      title: "Clinido",
      description: "جاري العمل تقنياً عليه وهيكون جاهز في خلال أيام",
      iconUrl: "https://www.google.com/s2/favicons?domain=clinido.com&sz=128",
      scope: "",
      bgColor: "bg-primary/10",
      connected: false,
      isComingSoon: true,
    },
    {
      ...
      title: "Tebcan",
      description: "جاري العمل تقنياً عليه وهيكون جاهز في خلال أيام",
      iconUrl: "https://www.google.com/s2/favicons?domain=tebcan.com&sz=128",
      scope: "",
      bgColor: "bg-primary/10",
      connected: false,
      isComingSoon: true,
    },
    {
      ...
      title: "Dactra",
      description: "جاري العمل تقنياً عليه وهيكون جاهز في خلال أيام",
      iconUrl: "https://www.google.com/s2/favicons?domain=dacktra.com&sz=128",
      scope: "",
      bgColor: "bg-primary/10",
      connected: false,
      isComingSoon: true,
    },
    {
      ...
      title: "Okadoc",
      description: "جاري العمل تقنياً عليه وهيكون جاهز في خلال أيام",
      iconUrl: "https://www.google.com/s2/favicons?domain=okadoc.com&sz=128",
      scope: "",
      bgColor: "bg-primary/10",
      connected: false,
      isComingSoon: true,
